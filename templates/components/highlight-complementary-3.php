...
<div class="col-sm-9" style="padding-bottom: 100px;">    
    ...
    <?php if ($terms && !is_wp_error($terms)) { ?>
        ...
        <?php } ?>
    <?php } ?>
    <div <?php post_class('highlight-complementary item'); ?> style="padding-right:70px; display: -webkit-box;">
        <!-- post thumbnail -->
        ...
        <!-- post title -->
        <h3 class="highlight-chapeu d-inline-block text-uppercase my-2">
